...
# Script: plot1.R
#
# This script plots the first graph in the first project
...
# 2. Generate plot
# 3. Write the plot to the plot1.png file in the current working directory
#
...
hist(dataTimeframe$Global_active_power, main = "Global Active Power", xlab = "Global Active Power (kilowatts)", col="red")
dev.off()
