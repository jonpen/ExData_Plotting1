...
# Script: plot2.R
#
# This script plots the second graph in the first project
...
# 2. Generate plot
# 3. Write the plot to the plot2.png file in the current working directory
#
...
with(dataTimeframe, { 
  plot(Date, Global_active_power, ylab="Global Active Power (kilowatts)", type="n")
